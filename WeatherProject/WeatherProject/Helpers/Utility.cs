...
namespace WeatherProject.Helpers
{
    ...
    public static class Utility
    {
        ...
        //#endif
       public static readonly string ServerUrl = "https://api.openweathermap.org/data/2.5/weather?q=sohag,eg&appid=4ccc668d10ab90efba3683f6d367d5cd";
            ...
            try
            {
                using (var client = GetClient())
                {
                    ...
                    catch (Exception ex)
                    {
                        ...
                        throw;
                        await App.Current.MainPage.DisplayAlert("message from server", ex.Message, "");
